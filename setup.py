import os, sys, pathlib, setuptools, sysconfig, platform, importlib_metadata, atexit
...
atexit.register(lambda: print(importlib_metadata.distribution(package_name).files))
